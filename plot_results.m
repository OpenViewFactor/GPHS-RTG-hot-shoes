...
brick_surface_area = 3.92*3.668 * 4;
total_stack_area = brick_surface_area * 18;

col_1_vfs = sum( results( : , : , 1 ) , 1 ) * brick_surface_area / total_stack_area;
col_2_vfs = sum( results( : , : , 2 ) , 1 ) * brick_surface_area / total_stack_area;
col_3_vfs = sum( results( : , : , 3 ) , 1 ) * brick_surface_area / total_stack_area;
col_4_vfs = sum( results( : , : , 4 ) , 1 ) * brick_surface_area / total_stack_area;
plot( 1:18 , col_1_vfs, "Marker", marker_1, "LineStyle", line_style, "Color", [1,0,0], "MarkerSize", marker_size, "LineWidth", line_width)
hold on
plot( 1:18 , col_2_vfs, "Marker", marker_2, "LineStyle", line_style, "Color", [1,0,1], "MarkerSize", marker_size, "LineWidth", line_width)
plot( 1:18 , col_3_vfs, "Marker", marker_3, "LineStyle", line_style, "Color", [0,0,1], "MarkerSize", marker_size, "LineWidth", line_width)
plot( 1:18 , col_4_vfs, "Marker", marker_4, "LineStyle", line_style, "Color", [0,1,0], "MarkerSize", marker_size, "LineWidth", line_width)
